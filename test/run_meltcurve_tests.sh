...
python3 test/diff_table.py test/temp_mca_3_out_raw_data.tsv test/test_mca_1_out_raw_data.tsv "Test 3 - raw data" 20 N Y
python3 test/diff_table.py test/temp_mca_3_out_smoothed.tsv test/test_mca_1_out_smoothed.tsv "Test 3 - smoothed data" 20 N Y
python3 test/diff_table.py test/temp_mca_3_out_normalized.tsv test/test_mca_3_out_normalized.tsv "Test 3 - normalized data" 20 N Y
python3 test/diff_table.py test/temp_mca_3_out_firstDerivative.tsv test/test_mca_3_out_firstDerivative.tsv "Test 3 - first Derivative" 20 N Y
python3 test/diff_table.py test/temp_mca_3_out_secondDerivative.tsv test/test_mca_3_out_secondDerivative.tsv "Test 3 - second Derivative" 20 N Y
python3 test/diff_table.py test/temp_mca_3_out_results.tsv test/test_mca_3_out_results.tsv "Test 3 - results" 20 N Y
